...
pub const TREE_SITTER_LANGUAGE_VERSION: u64 = 14;
pub const TREE_SITTER_MIN_COMPATIBLE_LANGUAGE_VERSION: u64 = 13;
...
extern "C" {
    ...
    pub fn ts_parser_included_ranges(self_: *const TSParser, count: *mut u64) -> *const TSRange;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_tree_included_ranges(self_: *const TSTree, length: *mut u64) -> *mut TSRange;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_node_start_byte(self_: TSNode) -> u64;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_node_end_byte(self_: TSNode) -> u64;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_node_child(self_: TSNode, child_index: u64) -> TSNode;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_node_child_count(self_: TSNode) -> u64;
}
extern "C" {
    #[doc = " Get the node's *named* child at the given index.\n\n See also [`ts_node_is_named`]."]
    pub fn ts_node_named_child(self_: TSNode, child_index: u64) -> TSNode;
}
extern "C" {
    #[doc = " Get the node's number of *named* children.\n\n See also [`ts_node_is_named`]."]
    pub fn ts_node_named_child_count(self_: TSNode) -> u64;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_node_first_child_for_byte(self_: TSNode, byte: u64) -> TSNode;
}
extern "C" {
    #[doc = " Get the node's first named child that extends beyond the given byte offset."]
    pub fn ts_node_first_named_child_for_byte(self_: TSNode, byte: u64) -> TSNode;
}
extern "C" {
    #[doc = " Get the node's number of descendants, including one for the node itself."]
    pub fn ts_node_descendant_count(self_: TSNode) -> u64;
}
extern "C" {
    #[doc = " Get the smallest node within this node that spans the given range of bytes\n or (row, column) positions."]
    pub fn ts_node_descendant_for_byte_range(self_: TSNode, start: u64, end: u64) -> TSNode;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_node_named_descendant_for_byte_range(self_: TSNode, start: u64, end: u64) -> TSNode;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_tree_cursor_goto_descendant(self_: *mut TSTreeCursor, goal_descendant_index: u64);
}
extern "C" {
    #[doc = " Get the index of the cursor's current node out of all of the\n descendants of the original node that the cursor was constructed with."]
    pub fn ts_tree_cursor_current_descendant_index(self_: *const TSTreeCursor) -> u64;
}
extern "C" {
    #[doc = " Get the depth of the cursor's current node relative to the original\n node that the cursor was constructed with."]
    pub fn ts_tree_cursor_current_depth(self_: *const TSTreeCursor) -> u64;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_query_pattern_count(self_: *const TSQuery) -> u64;
}
extern "C" {
    pub fn ts_query_capture_count(self_: *const TSQuery) -> u64;
}
extern "C" {
    pub fn ts_query_string_count(self_: *const TSQuery) -> u64;
}
extern "C" {
    #[doc = " Get the byte offset where the given pattern starts in the query's source.\n\n This can be useful when combining queries by concatenating their source\n code strings."]
    pub fn ts_query_start_byte_for_pattern(self_: *const TSQuery, pattern_index: u64) -> u64;
}
extern "C" {
...
extern "C" {
    pub fn ts_query_is_pattern_rooted(self_: *const TSQuery, pattern_index: u64) -> bool;
}
extern "C" {
    pub fn ts_query_is_pattern_non_local(self_: *const TSQuery, pattern_index: u64) -> bool;
}
extern "C" {
    pub fn ts_query_is_pattern_guaranteed_at_step(self_: *const TSQuery, byte_offset: u64) -> bool;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_query_disable_pattern(self_: *mut TSQuery, pattern_index: u64);
}
extern "C" {
...
extern "C" {
    pub fn ts_query_cursor_match_limit(self_: *const TSQueryCursor) -> u64;
}
extern "C" {
    pub fn ts_query_cursor_set_match_limit(self_: *mut TSQueryCursor, limit: u64);
}
extern "C" {
...
extern "C" {
    pub fn ts_query_cursor_remove_match(self_: *mut TSQueryCursor, match_id: u64);
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_query_cursor_set_max_start_depth(self_: *mut TSQueryCursor, max_start_depth: u64);
}
extern "C" {
    #[doc = " Get the number of distinct node types in the language."]
    pub fn ts_language_symbol_count(self_: *const TSLanguage) -> u64;
}
extern "C" {
    #[doc = " Get the number of valid states in this language."]
    pub fn ts_language_state_count(self_: *const TSLanguage) -> u64;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_language_field_count(self_: *const TSLanguage) -> u64;
}
extern "C" {
...
extern "C" {
    ...
    pub fn ts_language_version(self_: *const TSLanguage) -> u64;
}
extern "C" {
